<?php
include_once("da_port_director_admin.php");
class M_port_director_admin extends Da_port_director_admin {
	//=== add your functions below

	function getAll(){

		$sql = "SELECT * FROM port_director LEFT JOIN port_user ON port_director.di_id = port_user.usr_id;";
