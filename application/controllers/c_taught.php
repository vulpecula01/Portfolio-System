...
class C_taught extends Port_core {
	...
	public function getById(){
        ...
        echo '<div class="form-group">
            ...
            <div class="row">
                <div class="col-xs-6">
                    <label>ปีที่สอน <small class="error year"></small></label>
                ...
                <div class="col-xs-6">
                    <label>เทอมที่สอน <small class="error semeter"></small></label>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <label>รายชื่อวิชาที่สอน <small class="error subject"></small></label>
