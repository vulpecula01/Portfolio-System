<?php 
$strWordFileName = "PortfolioTeacher.doc"; 
...
<ul style="list-style-type:none">
	<li style="margin-left:-20px;">'.'วัน/เดือน/ปี เกิด                    '.thaiDate($person['usr_born']).''.'        ที่อยู่    '.$person['usr_location'].')</li>
	<li style="margin-left:-20px;">'.$person['acr_ename'].' '.$person['dep_ename'].' ('.$person['acr_tname'].' สาขาวิชา'.$person['dep_tname'].')</li>
	<li style="margin-left:-20px;">'.$person['dep_ename'].' (ภาควิชา'.$person['dep_tname'].')'.'       คณะ'.$person['usr_campus'].''.'      วิทยาเขต'.$person['usr_faculty'].' </li>
