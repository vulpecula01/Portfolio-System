      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="#"><i class="fa fa-edit"></i> <span>Information</span></a></li>
            <li><a href="<?php echo site_url('c_general_information')?>"><i class="fa fa-circle-o"></i> General Information</a></li>
            <li><a href="<?php echo site_url('c_education_background')?>"><i class="fa fa-circle-o"></i> Education Background</a></li>
            <li><a href="<?php echo site_url('c_job_experience')?>"><i class="fa fa-circle-o"></i> Jobs Experience</a></li>
            <li><a href="<?php echo site_url('c_interest')?>"><i class="fa fa-circle-o"></i> Interests</a></li>
            <li><a href="<?php echo site_url('c_research')?>"><i class="fa fa-circle-o"></i> Researches</a></li>
            <li><a href="<?php echo site_url('c_award')?>"><i class="fa fa-circle-o"></i> Awards</a></li>
            <li><a href="<?php echo site_url('c_taught')?>"><i class="fa fa-circle-o"></i> Teaching Experience</a></li>
            <li><a href="<?php echo site_url('c_letter_of_instruction')?>"><i class="fa fa-circle-o"></i> Letter of Instruction</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a target ="_blank" href="<?php echo site_url('c_export/pdf');?>"><i class="fa fa-file-text-o"></i>PDF</a></li>
                <li><a href="<?php echo site_url('c_export/word');?>"><i class="fa fa-file-text-o"></i>Word Document</a></li>
              </ul>
            </li>
