                ...
                <li class="treeview active">
                  ...
                  <ul class="treeview-menu">
                    <li class="treeview">
                      ...
                      <ul class="treeview-menu">
                        <li><a href="<?php echo site_url('c_info_department');?>"><i class="fa fa-circle-o"></i> Departments </a></li>
                        <li><a href="<?php echo site_url('c_info_interest');?>"><i class="fa fa-circle-o"></i> Interest </a></li>
                        <li><a href="<?php echo site_url('c_info_prefix');?>"><i class="fa fa-circle-o"></i> Prefix </a></li>
                        <li><a href="<?php echo site_url('c_info_subject');?>"><i class="fa fa-circle-o"></i> Subject </a></li>
                      </ul>
                    </li>
                    <li class="treeview">
                      <a href="#">
                      ...
                      <ul class="treeview-menu">
                        <li><a href="<?php echo site_url('c_info_research');?>"><i class="fa fa-circle-o"></i> Research Type </a></li>
                        <li><a href="<?php echo site_url('c_info_researcher_type');?>"><i class="fa fa-circle-o"></i> Researcher Type </a></li>
                      </ul>
                    </li>
                    <li class="treeview">
                      <a href="#">
                      ...
                      <ul class="treeview-menu">
                        <li><a href="<?php echo site_url('c_info_country');?>"><i class="fa fa-circle-o"></i> Country </a></li>
                        <li><a href="<?php echo site_url('c_info_degree');?>"><i class="fa fa-circle-o"></i> Degree </a></li>
                        <li><a href="<?php echo site_url('c_info_education_level');?>"><i class="fa fa-circle-o"></i> Education Level </a></li>
                        <li><a href="<?php echo site_url('c_info_institute');?>"><i class="fa fa-circle-o"></i> Institutes </a></li>
                        <li><a href="<?php echo site_url('c_info_major');?>"><i class="fa fa-circle-o"></i> Major </a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
                <li>
                  <a href="<?php echo site_url('c_manage_personal');?>">
