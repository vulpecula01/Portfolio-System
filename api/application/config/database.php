...
$db['port']['hostname'] = 'localhost';
$db['port']['username'] = 'dbuser';
$db['port']['password'] = 'dbpassword';
$db['port']['database'] = 'portfolio';
...
$db['user']['username'] = 'dbuser';
$db['user']['password'] = 'dbpassword';
$db['user']['database'] = 'portfolio_ums';
